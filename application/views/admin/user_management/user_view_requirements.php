...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Flashitt | Manage users requirement</title>
    ...
    <div class="page-content">
        ...
        <div id="portlet-config" class="modal hide">
            <div class="modal-header">
                ...
                <h3>Manage Users Requirement</h3>
            </div>
            <div class="modal-body">
                <p>Show Requirement Of All Users</p>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Users <small>Show Requirement Of All Users</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="<?php base_url('user_management'); ?>">Show Requirement Of All Users</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show Requirement Of All Users</div>
                            <div class="tools">
                                    ...
                                    if (isset($requirements)) {
                                        ...
                                        foreach ($requirements as $requirement) {
                                            ...
                                            <tr >
                                                ...
                                                <td><?php echo $requirement->category_name; ?></td>
                                                <td><?php echo $requirement->coun; ?></td>
                                                <td><a href = "<?php echo base_url('user_management/deleteRequirementsUsers').'/'.$requirement->id.'/'.$requirement->users_id; ?>" >Delete</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }

                                ...
                                <tbody>
                                    ...
                                    if (isset($users)) {
                                        ...
                                        foreach ($users as $user) {
                                            ...
                                            <tr >
                                                <td><?php echo $c; ?></td>
                                                <td><a href = "<?php echo base_url('user_management/showUsersDetails').'/'.$user->id; ?>" ><?php echo $user->name; ?></a></td>
                                                <td><?php echo $user->email; ?></td>
                                                <td><?php echo $user->about_me; ?></td>
                                                <td><a href = "<?php echo base_url('user_management/showUsersReports').'/'.$user->id; ?>" ><?php echo $count[$user->id]; ?></a></td>

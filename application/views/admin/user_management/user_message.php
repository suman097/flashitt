...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Flashitt | All users messages </title>
    ...
    <div class="page-content">
        ...
        <div id="portlet-config" class="modal hide">
            ...
            <div class="modal-body">
                <p>Show Messages Of All Users</p>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Users <small>Show Messages Of All Users</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="<?php base_url('user_management/message'); ?>">Show Messages Of All Users</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show Messages Of All Users</div>
                            <div class="tools">
                                    ...
                                    if (isset($messages)) {
                                        ...
                                        foreach ($messages as $message) {
                                            ...
                                            <tr >
                                                ...
                                                <td><?php echo date('d-m-Y H:i:s a', $message->created_at) ?></td>
                                            </tr>
                                            <?php
                                        }
                                    }

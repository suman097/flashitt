...
<head>
	<meta charset="utf-8" />
	<title>Flashitt | Sent Message to users </title>
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							...
							<small>Sent Message to users from admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="<?php echo base_url('company'); ?>">Sent Message to users</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="tabbable tabbable-custom boxless">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Sent Message to users</div>
											<div class="tools">
                          ...
                          <h3 class="form-section">Sent Message to users</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <label class="control-label" >Users</label>
                                      <div class="controls">
                                          <select  class="m-wrap span12" name = "users" >
                          ...
                          <div class="row-fluid">
                              <div class="span12 ">
                                  <div class="control-group">
                                      <label class="control-label" >Message Box</label>
                                      <div class="controls">
                                          <textarea class="span12 ckeditor m-wrap" name="message" rows="6" data-error-container="#editor2_error"></textarea>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="form-actions">
                              <button type="submit" class="btn blue"><i class="icon-ok"></i> Sent</button>

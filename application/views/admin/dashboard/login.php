...
<html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Flashitt Admin Panel | Login Page</title>
    ...
    <body class="login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <span style="font-size: 22px; font-weight: bold; color: #ffffff; padding-left: 4px;">Talent </span> <span style="font-size: 22px; font-weight: bold; color: #ff2300;">Hunt</span>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="form-vertical login-form" action="" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Email Address" name="username"/>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    <!--<label class="checkbox">
                        <input type="radio" name="type" value="2" checked/> Login as Teachers
                    </label>
                    <label class="checkbox">
                        <input type="radio" name="type" value="4"/> Login as Staff
                    </label>
                    <label class="checkbox">
                        <input type="radio" name="type" value="3"/> Login as Students
                    </label>
                    <label class="checkbox">
                        <input type="radio" name="type" value="1"/> Login as Admin
                    </label>-->

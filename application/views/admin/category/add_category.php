...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Flashitt | Add Category </title>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        Add Category
                        <small>Add category from admin</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="<?php echo base_url('company'); ?>">Add Category</a></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span12" name = "category"> 
                                                        </div>
                                                    </div>
                                                </div>

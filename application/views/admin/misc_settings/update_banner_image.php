...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Flashitt | Update Banner Image </title>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                         Update Banner Image
                        <small> Update banner image for forn page from admin</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li>
                            <a href="#">MISC Settings</a>
                            <span class="icon-angle-right"></span>
                        </li>
                        <li><a href="<?php echo base_url('misc_settings/bannerImageUpdate'); ?>">Upadte Banner Image</a></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-reorder"></i>Upadte Banner Image</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form action=" " class="horizontal-form" method="post" enctype="multipart/form-data">
                                            <h3 class="form-section">Upadte Banner Image</h3>
                                            <div class="row-fluid">
                                                <div class="span6 ">
                                                  <img src = "<?php echo base_url(); ?>images/misc/<?php echo $banner_image->content; ?>">
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span6 ">
                                                    <div class="control-group">
                                                        <label class="control-label">Upadte Banner Image</label>
                                                        <div class="controls">
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="hidden" class="default" name="banner_slug" value = "banner_image" />
                                                                    </span>

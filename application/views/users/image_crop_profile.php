...
<style type="text/css">
  #target {
    ...
    display: block;
					...
					<br>
					<img src = "<?php echo base_url(); ?>images/users/<?php echo $profile->image; ?>" id="cropbox" >
					<form action="<?php echo base_url('home/cropProfileImage'); ?>" method="post" onsubmit="return checkCoords();">
						...
						<a href = "<?php echo base_url('home/profile'); ?>"><input type="button" value="Skip" class="btn btn-large btn-inverse" style = "cursor:pointer; font-weight:bold; height:50px; margin-top:10px; width: 200px;" /></a>
					</form>
